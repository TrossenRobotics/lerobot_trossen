...
Example recording with bimanual WidowX AI arms:
...
python -m lerobot.record \
  ...
  --robot.cameras='{
    ...
    cam_high: {"type": "opencv", "index_or_path": 1, "width": 640, "height": 480, "fps": 30},
    cam_right_wrist: {"type": "opencv", "index_or_path": 2, "width": 640, "height": 480, "fps": 30}
  }' \
  --teleop.type=bi_widowxai_leader \
  --teleop.left_arm_ip_address=192.168.1.2 \
  --teleop.right_arm_ip_address=192.168.1.3 \
  --teleop.id=bi_widowxai_leader \
  --display_data=true \
...
def record(cfg: RecordConfig) -> LeRobotDataset:
    """Copied from lerobot.record, modified to work with Trossen LeRobot."""
    init_logging()
    ...
    with VideoEncodingManager(dataset):
        ...
        while recorded_episodes < cfg.dataset.num_episodes and not events["stop_recording"]:
            ...
            # Execute a few seconds without recording to give time to manually reset the
            # environment
            #
